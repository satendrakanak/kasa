...
const stats = [
  { value: "LMS", label: "Course delivery" },
  { value: "CRM", label: "Admissions follow-up" },
  { value: "Pay", label: "Payments and access" },
  { value: "Web", label: "Academy storefront" },
];

const outcomeCards = [
  {
    title: "Course selling setup",
    label: "For online academies",
    body:
      "Build branded course pages, collect payments, unlock learner access, and keep enrolments connected with the same LMS workspace.",
    initials: "CS",
    tone: "from-blue-500/14 via-white to-emerald-500/10",
  },
  {
    title: "Live batch operations",
    label: "For coaching teams",
    body:
      "Plan batches, share live class links, organize replays, track learners, and reduce scattered follow-ups across chat and spreadsheets.",
    initials: "LB",
    tone: "from-emerald-500/14 via-white to-sky-500/10",
  },
  {
    title: "Learner lifecycle",
    label: "For institute admins",
    body:
      "Manage enquiries, admissions, fee status, course access, assignments, certificates, and learner progress from one operational view.",
    initials: "LL",
      ...
      <div className={siteContainerClasses({ className: "relative z-10" })}>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-5 font-heading text-3xl font-semibold leading-tight text-slate-950 sm:text-5xl dark:text-white">
            Academy teams can build{" "}
            <span className="stat-gradient-text animate-[gradient-shift_4s_ease-in-out_infinite]">
              cleaner learning operations
            </span>{" "}
            with KASA.
          </h2>
          <p className="mx-auto mt-5 max-w-3xl text-sm leading-7 text-slate-600 sm:text-base dark:text-slate-300">
            KASA is designed for coaching institutes, online academies,
            trainers, and EdTech teams that want courses, live classes,
            payments, learners, and certificates to work together.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            ...
            <div className="relative flex min-h-[28rem] flex-col justify-between">
              <div>
                ...
                <p className="mt-5 text-xs font-semibold uppercase tracking-[0.18em] text-primary dark:text-emerald-200">
                  Connected academy setup
                </p>
                <h3 className="mt-3 font-heading text-3xl font-semibold leading-tight text-slate-950 sm:text-4xl dark:text-white">
                  Bring your website, LMS, payments, and batches into one
                  operating flow.
                </h3>
                <p className="mt-5 text-sm leading-7 text-slate-600 dark:text-slate-300">
                  A typical KASA rollout can connect course sales, live
                  batches, learner access, fee collection, replays, and
                  certificates inside one branded academy setup so teams have
                  fewer scattered tools to manage.
                </p>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3 text-sm font-semibold text-slate-700 dark:text-slate-200">
                  <span>Example institute flow</span>
          ...
          <div className="grid gap-4">
            {outcomeCards.map((item, index) => (
              <article
                key={item.title}
                className={`rounded-[2rem] border border-blue-950/10 bg-gradient-to-br ${item.tone} p-5 shadow-xl shadow-blue-950/7 dark:border-white/10 dark:from-white/[0.06] dark:via-white/[0.03] dark:to-emerald-400/8`}
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <BadgeCheck className="size-8 text-primary/35" aria-hidden="true" />
                </div>
