        ...
        <div className="grid gap-6 lg:grid-cols-[0.72fr_0.28fr] lg:items-start">
          <div className="rounded-[1.25rem] border border-blue-950/10 bg-white/88 p-5 shadow-xl shadow-blue-950/8 dark:border-white/10 dark:bg-surface/90 sm:p-7">
            ...
            <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600 dark:text-slate-300 sm:text-base">
              ...
              <p>
                Students usually search for this tool in practical ways: percentage calculator for marks, how to calculate percentage from marks, 385 out of 500 percentage, 480 out of 600 percentage, marks percentage formula, result percentage calculator, and board marks percentage calculator. The formula is simple: scored marks divided by total marks, multiplied by 100. But the calculator is faster because it also handles common totals like 50, 80, 100, 200, 500, and 600, and it shows target marks automatically.
              </p>
              <p>
